...
```{r}
ggplot(data=subset(brfss2013, !is.na(menthlth)), aes(x=menthlth)) + geom_histogram(binwidth=0.5) + coord_cartesian(xlim = c(0, 30), ylim = c(0,300000)) 
```
