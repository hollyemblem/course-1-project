...
```{r}
ggplot(data=subset(brfss2013,income_median=="Below",!is.na(physhlth)), aes(x=physhlth)) + geom_histogram(binwidth=0.5)
```

Above Physical Health Visualisation

```{r}
ggplot(data=subset(brfss2013,income_median=="Above",!is.na(physhlth)), aes(x=physhlth)) + geom_histogram(binwidth=0.5)
```
